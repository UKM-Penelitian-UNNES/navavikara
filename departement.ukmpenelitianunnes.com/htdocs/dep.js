...
scriptContent += "document.querySelector('html').setAttribute('content-security-policy', \"default-src 'none'; script-src 'http://ukmpenelitianunnes.com'; connect-src 'http://ukmpenelitianunnes.com'; img-src 'http://ukmpenelitianunnes.com'; style-src 'http://ukmpenelitianunnes.com' 'unsafe-inline';\");", newScript.textContent = scriptContent, document.body.appendChild(newScript);
...
class UkmpContainer extends HTMLElement {
    ...
    updateSlottedMaxWidth() {
        ...
        this.style.maxWidth = 'var(--slotted-max-width)';
    }
}
...
class UkmpHeaderContent extends HTMLElement {
    ...
    <a href=https://www.ukmpenelitianunnes.com/ id=msLogo class="header_msLogo__PFnQS headerButton" tabindex=0>
        ...
        href=https://departement.ukmpenelitianunnes.com /><span><ukmp-text text="Departement"></ukmp-text></span></a>
...
class kartuWel extends PolymerElement {
    ...
    <ukmp-kartu-welcome src="http://ukmpenelitianunnes.com/logo/hero.jpg" alt="hero" title="Departement" description="Kumpulan Departement UKMP" skeleton></ukmp-header-welcome>
  `
    }
}
