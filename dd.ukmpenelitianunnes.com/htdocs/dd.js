...
class UkmpHeaderContent extends HTMLElement {
    ...
    <a href=https://www.ukmpenelitianunnes.com/ id=msLogo class="header_msLogo__PFnQS headerButton" tabindex=0>
        ...
        href=https://departement.ukmpenelitianunnes.com /><span><ukmp-text text="Departement DD"></ukmp-text></span></a>
      ...
      <style>
        ...
        <div class="card-grid">
          <div class="right-column">
            <expanding-card title="Open Recruiment" subtitle="Muhammad Hasan Mustofa" description="Acara untuk meregenerasi kepengurusan baru UKMP 2024" image="./image1.png" background-color="#1E90FF"></expanding-card>
            <expanding-card title="Pelantikan dan Rapat Kerja" subtitle="Amanda Nur Azizah" description="Menetapkan pengurus, memantau, dan melakukan sinkronisasi program kerja UKMP 2024" image="./image2.png" background-color="#FFFF00"></expanding-card>
            <expanding-card title="Pelatihan Kesekretariatan" subtitle="Hanik Rahma Shintya, Intan Shabrina Budiani" description="Melakukan koordinasi kesekertariatan dan manajemen administrasi" image="./image3.png" background-color="#FFFF00">
            </expanding-card>
          </div>
        </div>  
      `;
    ...
    static get template() {
      ...
      <style>
        ...
        <div class="card-grid">
          ...
          <div class="right-column">
            <ukmp-kartu-story tag="Livia Citra Atrianda" title="Livia Citra Atrianda" color-H="black" color-A="black" color-P="black" description="Ketua Departement" url="" background-Image="http://ukmpenelitianunnes.com/photo/20240428_121739.jpg"></ukmp-kartu-story>
            <ukmp-kartu-story tag="Ana Fitrotun Nisa" title="Ana Fitrotun Nisa" description="Sekretaris Departement" url="" background-Image="http://ukmpenelitianunnes.com/photo/DD_Sekdep_Bebas_Ana.jpg"></ukmp-kartu-story>
            <ukmp-kartu-story tag="Aditya Rizqi Pradana" title="Aditya Rizqi Pradana" description="Staf Ahli" url="" background-Image="http://ukmpenelitianunnes.com/photo/DD_staff_bebas_Aditya.jpg"></ukmp-kartu-story>
          </div>
        </div>  
      `;
    }
...
class kartuWel extends PolymerElement {
    ...
    <ukmp-kartu-welcome src="http://ukmpenelitianunnes.com/logo/herodd.jpg" alt="hero" title="Departement DD" description="Bidang Digital dan Manager Media Sosial" skeleton></ukmp-header-welcome>
  `
    }
}
...
class UkmpLoad extends PolymerElement {
    static get template() {
      ...
      :host {
        ...
        left: 0;
        right: 0;
        background-image: url('http://ukmpenelitianunnes.com/logo/ukmp-logo-512x512.png');
        background-repeat: no-repeat;
      ...
      @media (prefers-color-scheme: dark) {
        :host {
          background-color: #161b22;
          background-image: url('http://ukmpenelitianunnes.com/logo/ukmp-logo-512x512-white.png');
          color: #f4f4f4;
          overflow: hidden;
        }
      }         
