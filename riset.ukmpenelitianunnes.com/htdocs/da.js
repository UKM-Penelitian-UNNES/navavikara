...
class HomeApp extends PolymerElement {
    ...
    static get template() {
        ...
        <div class="container">
            ...
            <navavikara-view title="{{selectedPdfTitle}}">
    ...
    fetchPdfFiles() {
        fetch('https://riset.ukmpenelitianunnes.com/list-pdf.php')
            ...
            .then(data => {
                ...
                this.pdfFiles.forEach((pdfFile, index) => {
                    const fileURL = `https://riset.ukmpenelitianunnes.com/riset/${pdfFile.fileName}`;
    ...
    openPdf(event) {
        ...
        const fileURL = `https://riset.ukmpenelitianunnes.com/riset/${pdfFile}`;
